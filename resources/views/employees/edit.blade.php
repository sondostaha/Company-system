        ...
        <div class="my-auto">
            <div class="d-flex">
                <h4 class="content-title mb-0 my-auto">Company</h4><span class="text-muted mt-1 tx-13 mr-2 mb-0">/
                    Eite employee{{$employee->id}}</span>
            </div>
        </div>
    </div>
    <!-- breadcrumb -->
                ...
                <div class="card-body">
                    <form action="{{route('update.employee',$employee->id)}}" method="post" enctype="multipart/form-data"
                        ...
                        <div class="col">
                            ...
                            <input id="name" name="name" class="form-control" value="{{$employee->name}}" required>
                            
                        </div>

                        <div class="col">
                            <label for="inputName" class="control-label">Email</label>
                            <input id="email" name="email" class="form-control" value="{{$employee->email}}" required>
                            ...
                            <div class="col">
                                ...
                                <input class="form-control fc-datepicker" name="birthdate"  value="{{$employee->birthdate}}"
                                    type="text" required>
                            </div>
                        ...
                        <div class="row">
                            <div class="col">
                                ...
                                <select name="position" class="form-control SlectBox" onclick="console.log($(this).val())"
                                    ...
                                    <!--placeholder-->
                                    <option  value="{{$employee->position->id}}" selected disabled>{{$employee->position->name}} </option>
                        ...
                        <div class="row">
                            ...
                            <div class="col">
                                ...
                                <input type="text" class="form-control form-control-lg" id="e_salary" value="{{$employee->salary}}"
