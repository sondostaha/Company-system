                    ...
                    <form action="{{route('update_project',$project->id)}}" method="post" enctype="multipart/form-data"
                        ...
                        <div class="row">
                            <div class="col">
                                ...
                                <textarea class="form-control" id="exampleTextarea" name="description"  rows="3">{{$project->description}}</textarea>
                            </div>
                        </div>
                        ...
                        <div class="col">
                            ...
                            <select name="status" id="status" class="form-control" onchange="myFunction()">
                                <!--placeholder-->
                                <option value="{{$project->status}}" selected disabled>{{$project->status}}</option>
                            ...
                            <div class="col">
                                ...
                                <input class="form-control fc-datepicker" name="start_date"  value="{{$project->start_date}}"
                                    type="text">
                            </div>

                            <div class="col">
                                <label> End_date	</label>
                                <input class="form-control fc-datepicker" name="end_date"   value="{{$project->end_date}}"
                                    type="text"   >
                            </div>
