									...
									<div class="d-flex">
										...
										<span class="float-right my-auto mr-auto">
											...
											<span class="text-white op-7"> 
												...
												{{round(App\Models\Projects::where('status','new')->count() / App\Models\Projects::count() * 100)}}%
									...
									<div class="d-flex">
										...
										<span class="float-right my-auto mr-auto">
											...
											<span class="text-white op-7"> 
												...
												{{round(App\Models\Projects::where('status','pending')->count() / App\Models\Projects::count() * 100)}}%
									...
									<div class="d-flex">
										...
										<span class="float-right my-auto mr-auto">
											...
											<span class="text-white op-7">
												...
												{{round(App\Models\Projects::where('status','inprogress')->count() / App\Models\Projects::count() * 100)}}%
